...
> Статус 14.08.2026: local-first маршрутизация, Hermes/Ollama, Codex/Claude handoff
> и локальный vision-контур реализованы. Актуальная схема и тесты:
...
11. Подготовлен изолированный Python runtime с проверенным lock-файлом. В нём
    `pip check`, 182 теста и security gate проходят без необработанных уязвимостей;
