...
ORCHESTRATOR_COMMANDS = (
    ...
    ("context", "Показать активную задачу и документ"),
    ("new", "Начать новую задачу, сохранив старые результаты"),
...
def command_menu_text(kind: str) -> str:
    if kind == "orchestrator":
        return (
            ...
            "/context — показать активную задачу, исполнителя и документ.\n"
            "/new — отделить новую задачу; старые результаты сохранятся.\n"
